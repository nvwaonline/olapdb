...
//			ResultSet resultSet = state.executeQuery("select \"orgName\",  \"FACT_COUNT\"  from \"biz\".\"detail_analysis_simple\" limit 1000");
			ResultSet resultSet = state.executeQuery("select * from \"biz\".\"detail_analysis_simple\" limit 1000");
