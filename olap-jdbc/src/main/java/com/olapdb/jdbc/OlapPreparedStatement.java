...
public class OlapPreparedStatement extends AvaticaPreparedStatement {

    protected OlapPreparedStatement(AvaticaConnection connection, StatementHandle h, Signature signature, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
